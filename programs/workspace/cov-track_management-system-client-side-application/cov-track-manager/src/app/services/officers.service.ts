...
export class OfficersService {
  ...
  getCDCOfficers(type)
  {
      return this.httpClient.get<{message : string, data : any}>(this.serverPort+'api/officers/' + type).subscribe(res=>{
  ...
  getOfficer(email)
  {
      return this.httpClient.get<{message : string, data : any}>(this.serverPort+'api/officer/' + email).subscribe(res=>{
